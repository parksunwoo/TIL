...
![statistics_3_1](../../etc/img/statistics_3_1.png)
...
![statistics_7_1](../../etc/img/statistics_7_1.png)
...
![statistics_7_3](../../etc/img/statistics_7_3.png)
...
![statistics_14_1](../../etc/img/statistics_14_1.png)
![statistics_14_2](../../etc/img/statistics_14_2.png)
![statistics_14_3](../../etc/img/statistics_14_3.png)
...
![statistics_15_1](../../etc/img/statistics_15_1.png)

### 포아송 분포 (Poisson distribution)
시간 t까지 받는 이메일의 수가 Pois(λt) 를 따른다고 할 때, 첫 번째 이메일까지 걸리는 시간 T1 의 분포를 구하시오.
![statistics_15_2](../../etc/img/statistics_15_2.png)
